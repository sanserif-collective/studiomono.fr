...
export class MenuToggle extends HTMLElement {
  ...
  private createShiftTween = (event: MediaQueryListEvent | MediaQueryList | undefined) => {
  ...
  public connectedCallback() {
    ...
    app.plugins.barba?.hooks.after(() => this.createShiftTween(app.plugins.portrait?.media));
  }
